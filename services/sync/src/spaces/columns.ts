 ...
 *  path, file and icon is bounded on its own, and this is what stops a map of
 *  entries that are all legal from making the space listing heavy for every device
 *  that reads it.
 *

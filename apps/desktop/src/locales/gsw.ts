...
export const gsw: Dictionary = {
  ...
  'New canvas': 'Neui Leinwand',
  Canvas: 'Leinwand',
  Card: 'Chärtli',
  'Note or picture': 'Notiz oder Bild',
  Group: 'Gruppe',
  'Fit the canvas': 'Leinwand ipasse',
  ...
  'Reading the space…': 'De Bereich wird gläse…',
  'New unique note': 'Nou eindüti Notiz',
  ...
  'Deleted notes and spaces wait here for 14 days, then they are gone for good.':
    'Glöschti Notize und Spaces warted da 14 Täg, dänn sind si für immer wäg.',
  ...
  'you can only read this space': 'Dä Bereich chasch nur läse',
  'only the owner can do that': 'Das cha nur de Bsitzer',
  'this space is already yours': 'Dä Bereich ghört dir scho',
  'that is as many people as one space holds': 'Meh Lüt hät en Bereich nöd Platz',
  ...
  'Share this space': 'Dä Bereich teile',
  People: 'Lüt',
  Owner: 'Bsitzer',
  'The owner': 'De Bsitzer',
  Somebody: 'Öpper',
  Role: 'Rolle',
  Read: 'Läse',
  Invite: 'Iilade',

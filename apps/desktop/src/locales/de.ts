...
export const de: Dictionary = {
  ...
  'Deleted notes and spaces wait here for 14 days, then they are gone for good.':
    'Gelöschte Notizen und Spaces warten hier 14 Tage, dann sind sie endgültig weg.',
  ...
  'Waiting to be let in': 'Wartet auf Einlass',
  '{who} has been asked about {space}.': '{who} wurde wegen {space} gefragt.',

...
export const ja: Dictionary = {
  ...
  'Esc stops recording, Backspace takes the key away.': 'Esc で中止、Backspace で割り当てを解除します。',
  'Tables': '表',
  'Pictures': '画像',
  'Fixed keys': '固定キー',
  'Underline': '下線',
  ...
  'Enter closes a code block and carries a list on.': 'Enter はコードブロックを閉じ、リストを続けます。',
  'Tab moves on through the app as well as indenting.': 'Tab はインデントし、操作対象も移動します。',
  'Escape closes whatever is open.': 'Esc は開いているものを閉じます。',
  'Your system takes this key before the app sees it.': 'このキーはアプリより先にシステムが受け取ります。',
